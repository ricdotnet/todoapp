        ...
        <div v-if="!$auth.loading">
            ...
            <div class="mb-10 text-3xl font-bold">
                ...
                <div v-if="$auth.isAuthenticated">
                    ...
                    <button @click.prevent="logout" class="ml-20 text-sm pl-5 pr-5 pt-2 pb-2 bg-red-500 focus:outline-none hover:bg-red-600 active:bg-red-700 align-middle shadow">
                        Logout
                    </button>
                </div>
                <div v-else>
