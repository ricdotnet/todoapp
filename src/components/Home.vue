  ...
  <div class="text-center mt-10">
    ...
    <div v-if="!$auth.loading">
      <div class="mb-10 text-3xl font-bold">
        ...
        <div v-else>
          <span class="align-middle text-shadow"
            >Login or register to use the system.</span
          >
          <div class="text-sm font-thin mt-5">
            To try this app use the following:<br />
            teste@test.com :: $why$is$this123
          </div>
        </div>
      </div>
    ...
    <div class="font-mono mt-10 mb-10">made with VueJS => ricr.dev</div>
  </div>
</template>
